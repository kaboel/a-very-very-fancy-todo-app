...
-- AddForeignKey
ALTER TABLE "PatientOnDoctor" ADD CONSTRAINT "PatientOnDoctor_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PatientOnDoctor" ADD CONSTRAINT "PatientOnDoctor_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "Patient"("id") ON DELETE CASCADE ON UPDATE CASCADE;
